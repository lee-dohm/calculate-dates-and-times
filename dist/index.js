...
const moment_1 = __importDefault(__webpack_require__(623));
/**
...
function getDuration(text) {
    if (text.match(/^\s*$/)) {
        throw new Error('A duration specification must be supplied such as "2 days", but none was given');
    }
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let value = moment_1.default().utc();
            if (add) {
